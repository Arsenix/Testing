...
#        frame.pack()
        ...
        self.boton1 = Botao(raiz, "1", 3, 2, lambda : self.Numero(1))
        self.boton2 = Botao(raiz, "2", 3, 3, lambda : self.Numero(2))
        self.boton3 = Botao(raiz, "3", 3, 4, lambda : self.Numero(3))
        self.boton4 = Botao(raiz, "4", 4, 2, lambda : self.Numero(4))
        self.boton5 = Botao(raiz, "5", 4, 3, lambda : self.Numero(5))
        self.boton6 = Botao(raiz, "6", 4, 4, lambda : self.Numero(6))
        self.boton7 = Botao(raiz, "7", 5, 2, lambda : self.Numero(7))
        self.boton8 = Botao(raiz, "8", 5, 3, lambda : self.Numero(8))
        self.boton8 = Botao(raiz, "9", 5, 4, lambda : self.Numero(9))
        self.boton8 = Botao(raiz, "0", 5, 5, lambda : self.Numero(0))

        self.boton_suma = Botao(raiz, "+", 3, 5, self.Soma )
        self.boton_subtracao = Botao(raiz, "-", 4, 5, self.Subtracao)
        self.boton_subtracao = Botao(raiz, "*", 3, 6, self.Multiplicacao)
        self.boton_subtracao = Botao(raiz, "/", 4, 6, self.Divisao)
        self.boton_igual = Botao(raiz, "=", 5, 6, self.Igual)
        ...
        self.botao_raiz_quadrada = Botao(raiz, "pote 2", 2, 2, self.Pow)
